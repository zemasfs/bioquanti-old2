...
1.  [St. Olaf College - Jmol & JSmol (applet direto para JSmol)](https://chemapps.stolaf.edu/jmol/jsmol/simple.htm){target="_blank"}

2.  [First Glance in Jmol](https://proteopedia.org/wiki/fgij/){target="_blank"}

| Para "rodar" o script anterior, por exemplo,

1.  Entre no site [St. Olaf College - Jmol & JSmol)](https://chemapps.stolaf.edu/jmol/jsmol/simple.htm){target="_blank"};
...
[![](jsmol.png){width="20%"}](https://chemapps.stolaf.edu/jmol/jmol.php?model=water&script=Console){target="_blank"}
...
|       Existem diversos *sites* de internete para estudo de biomoléculas com auxílio do *JSmol*, incluindo aminoácidos. Como exemplo, a [*Seção de Moléculas Interativas*](https://www.ufrgs.br/bioquimica/#Moleculas){target="_blank"} desenvolvida pelo Depto. de Patologia Clínica Veterinária da UFRGS.
